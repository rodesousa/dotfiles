...
-- Fix asdf PATH for Mason
vim.cmd("let $PATH = '" .. vim.fn.expand '~/.asdf/shims' .. ":' . $PATH")
...
-- Buffer
vim.keymap.set('n', '<leader>tt', ':TestNearest<cr>', { desc = 'Run the test' })
vim.keymap.set('n', '<leader>tT', ':TestFile<cr>', { desc = 'Run all file tests' })

vim.keymap.set('n', '<leader>ao', ':Telescope lsp_document_symbols<cr>', { desc = 'Outline' })
...
-- Pairs
vim.keymap.set('n', 'd*', 'viwc*<C-r>"*<Esc>', {})
vim.keymap.set('v', 'd*', 'c*<C-r>"*', {})
...
vim.keymap.set('n', 'd^', 'viwc<<C-r>"></<C-r>"><Esc>', {})
vim.keymap.set('v', 'd^', 'c<<C-r>"></<C-r>">', {})
...
-- Diagnostic & Trouble keymaps
vim.keymap.set('n', '[d', vim.diagnostic.goto_prev, { desc = 'Go to previous [D]iagnostic message' })
vim.keymap.set('n', ']d', vim.diagnostic.goto_next, { desc = 'Go to next [D]iagnostic message' })
vim.keymap.set('n', '<leader>e', ':Neotree reveal<CR>', { desc = 'Neotree reveal/close' })
vim.keymap.set('n', '<leader>W', vim.diagnostic.open_float, { desc = 'Show diagnostic [E]rror messages' })
vim.keymap.set('n', '<leader>w', ':Trouble diagnostics<cr>', { desc = 'Open Trouble' })
...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    config = function() -- This is the function that runs, AFTER loading
      ...
      require('which-key').register {
        ...
        ['<leader>w'] = { name = '[w]arnings', _ = 'which_key_ignore' },
        ['<leader>W'] = { name = '[W]arnings2', _ = 'which_key_ignore' },
  ...
  --       ollama = {
  --         api_key_name = '',
  --         endpoint = 'http://100.81.198.158:11434',
  --         model = 'deepseek-coder-v2:16b',
  --         parse_curl_args = function(opts, code_opts)
  --           return {
  --             url = opts.endpoint .. '/v1/completions',
  --             headers = {
...
vim.api.nvim_create_user_command('DayMode', function()
  vim.o.background = 'light'
  vim.cmd.colorscheme 'tokyonight-day'
end, {})

vim.api.nvim_create_user_command('NightMode', function()
